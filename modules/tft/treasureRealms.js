...
exports.treasureRealmsFetch = treasureRealmsFetch;
...
function treasureRealmsFetch(credentials) {
    return __awaiter(this, void 0, void 0, function () {
        var temp, data, patch, _i, data_1, banner, checkIfExists, dbBanner, request_1, request;
        return __generator(this, function (_a) {
            switch (_a.label) {
                ...
                case 5:
                    ...
                    banner = data_1[_i];
                    return [4 /*yield*/, pocketbase_1.pb.collection('treasureRealms').getFullList({ filter: "bannerId=\"".concat(banner.id, "\"") })];
                case 6:
                    ...
                    if (!(checkIfExists.length > 0)) return [3 /*break*/, 8];
                    return [4 /*yield*/, pocketbase_1.pb.collection('treasureRealms').update(checkIfExists[0].id, dbBanner)];
                case 7:
                    request_1 = _a.sent();
                    console.log("Updated treasure realm entry with ID: " + checkIfExists[0].id);
                    return [3 /*break*/, 10];
                case 8: return [4 /*yield*/, pocketbase_1.pb.collection('treasureRealms').create(dbBanner)];
                case 9:
                    request = _a.sent();
