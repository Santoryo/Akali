...
function yourShopFetch(credentials) {
    return __awaiter(this, void 0, void 0, function () {
        var temp, yourShop, checkIfExists, request;
        return __generator(this, function (_a) {
            switch (_a.label) {
                ...
                case 3:
                    _a.sent();
                    return [4 /*yield*/, pocketbase_1.pb.collection('yourshops').getFullList({ filter: "name=\"".concat(yourShop.name, "\"") })];
                case 4:
                    checkIfExists = _a.sent();
                    if (!(checkIfExists.length <= 0)) return [3 /*break*/, 6];
                    return [4 /*yield*/, pocketbase_1.pb.collection('yourshops').create(yourShop)];
                case 5:
                    request = _a.sent();
                    console.log("Created new yourshop entry with ID: " + request.id);
                    return [2 /*return*/, yourShop];
                case 6:
